...
//go:generate minimock -i github.com/Sysleec/auth/internal/service.UserService -o user_service_minimock.go -n UserServiceMock
...
func (mmCreate *mUserServiceMockCreate) Expect(ctx context.Context, usr *model.User) *mUserServiceMockCreate {
	...
	mmCreate.defaultExpectation.params = &UserServiceMockCreateParams{ctx, usr}
...
func (mmCreate *mUserServiceMockCreate) Inspect(f func(ctx context.Context, usr *model.User)) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) Set(f func(ctx context.Context, usr *model.User) (i1 int64, err error)) *UserServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserServiceMockCreate) When(ctx context.Context, usr *model.User) *UserServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
	...
	expectation := &UserServiceMockCreateExpectation{
		mock:   mmCreate.mock,
		params: &UserServiceMockCreateParams{ctx, usr},
	}
...
func (mmCreate *UserServiceMock) Create(ctx context.Context, usr *model.User) (i1 int64, err error) {
	...
	mm_params := UserServiceMockCreateParams{ctx, usr}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockCreateParams{ctx, usr}
	...
	mmCreate.t.Fatalf("Unexpected call to UserServiceMock.Create. %v %v", ctx, usr)
	return
}
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, usr *model.User) *mUserServiceMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserServiceMockUpdateParams{ctx, usr}
...
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, usr *model.User)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, usr *model.User) (ep1 *emptypb.Empty, err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, usr *model.User) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
	...
	expectation := &UserServiceMockUpdateExpectation{
		mock:   mmUpdate.mock,
		params: &UserServiceMockUpdateParams{ctx, usr},
	}
...
func (mmUpdate *UserServiceMock) Update(ctx context.Context, usr *model.User) (ep1 *emptypb.Empty, err error) {
	...
	mm_params := UserServiceMockUpdateParams{ctx, usr}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockUpdateParams{ctx, usr}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmUpdate.t.Fatalf("Unexpected call to UserServiceMock.Update. %v %v", ctx, usr)
	return
}
